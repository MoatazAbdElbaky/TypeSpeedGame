...
for (let i = 0; i < wordNumber; i++) {
    arr.push(wordArray[Math.ceil(Math.random() * wordArray.length)]);
}
...
function genWords() {
    ...
    arr.splice(arr.indexOf(randomWord), 1);
...
options.forEach((op) => {
    op.onclick = () => {
        ...
        window.localStorage.setItem("lvl", op.innerHTML);
        lvlNameSpan.innerHTML = window.localStorage.getItem("lvl")
            ? window.localStorage.getItem("lvl")
            : defaultLevelName;
...
window.onload = function () {
    lvlNameSpan.innerHTML = window.localStorage.getItem("lvl")
        ? options.forEach((op) => {
              if (op.innerHTML == window.localStorage.getItem("lvl"))
                  op.classList.add("selected");
    ...
    lvlNameSpan.innerHTML = window.localStorage.getItem("lvl")
        ? window.localStorage.getItem("lvl")
        : defaultLevelName;
    defaultLevelSeconds = lvls[lvlNameSpan.innerHTML];
    secondsSpan.innerHTML = defaultLevelSeconds;
    scoreGot.innerHTML = 0;
    scoreTotal.innerHTML = wordNumber;
    secondsSpan.innerHTML = defaultLevelSeconds;
    timeLeftSpan.innerHTML = defaultLevelSeconds;
};
